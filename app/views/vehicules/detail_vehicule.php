...
<body class="bg-gray-50">
    ...
    <nav class="bg-slate-800 text-white p-4 shadow-lg">
        <div class="max-w-5xl mx-auto flex justify-between items-center">
            ...
            <a href="../index" class="text-sm bg-slate-700 px-4 py-2 rounded hover:bg-slate-600 transition">← Retour au blog</a>
        </div>
    </nav>
    ...
    <main class="max-w-4xl mx-auto my-10 px-4">
        ...
        <article class="bg-white rounded-2xl shadow-sm overflow-hidden border border-gray-100">
            ...
            <div class="p-8">
                <div class="flex justify-between items-start mb-4">
                    ...
                    <!-- Bouton Favoris -->
                    <?php if($user_id): ?>
                        <a href="../detail?id=<?= $article_id ?>&action=toggle_fav" 
                ...
                <div class="flex flex-wrap gap-2 pt-6 border-t">
                    ...
                    <?php foreach($tagsArticle as $t): ?>
                        <a href="../index?tag=<?= $t['id_tag'] ?>" class="text-sm bg-gray-100 px-3 py-1 rounded-lg hover:bg-blue-500 hover:text-white transition">
        ...
        <section class="mt-12">
            ...
            <?php if($user_id): ?>
                <form action="../index/detail?id=<?= $article_id ?>" method="POST" class="bg-white p-6 rounded-xl shadow-sm mb-8">
